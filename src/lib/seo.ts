...
export const SECTIONS_SEO: Record<SectionId, SectionSEOData> = {
  ...
  styles: {
    ...
    label: "AI-стили",
    icon: "Wand2",
    title: "AI-комплект под стиль интерьера: сканди, лофт, японди, классика с готовой сметой — RoomScan AI",
    description:
      "Выберите стиль интерьера (13 направлений: сканди, японди, лофт, классика, ар-деко, бохо, прованс, wabi-sabi) и уровень бюджета — ИИ соберёт согласованный комплект: отделка стен, пол, мебель и водяной тёплый пол VALTEC. Готовая палитра и смета в одном клике.",
    keywords:
      "ai дизайн интерьера, готовый комплект под стиль, подбор материалов по стилю онлайн, дизайн в стиле сканди, японди интерьер, лофт квартира, классика интерьер, ар-деко онлайн, бохо стиль, прованс дизайн, wabi-sabi, midcentury, минимализм, готовая смета по стилю, генератор стилей интерьера",
    h1: "AI-комплект под стиль интерьера",
  },
  calc: {
    id: "calc",
    label: "Смета ремонта",
