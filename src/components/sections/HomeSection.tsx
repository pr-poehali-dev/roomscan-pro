...
const FEATURES = [
  ...
  },
  {
    ...
    icon: "Calculator",
    title: "Смета онлайн",
    desc: "Расчёт работ и материалов с реальными ценами по вашему региону",
    badge: null,
  },
  {
    id: "catalog",
    ...
    desc: "Тысячи моделей от партнёров с моментальной примеркой в комнате",
    badge: null,
  },
  {
    id: "export",
...
const STATS = [
  { value: "30 сек", label: "среднее сканирование" },
  { value: "±2 см", label: "точность измерений" },
